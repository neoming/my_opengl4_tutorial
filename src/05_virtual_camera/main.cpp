...
#define GLSL_PATH "src/05_virtual_camera/"
...
int main() {
  ...
  parse_file_into_str( GLSL_PATH"test_vs.glsl", vertex_shader, 1024 * 256 );
  parse_file_into_str( GLSL_PATH"test_fs.glsl", fragment_shader, 1024 * 256 );
