...
int main()
{
    ...
    parse_file_into_str("src/04_mat_and_vec/test_vs.glsl", vertex_shader, 1024 * 256);
    parse_file_into_str("src/04_mat_and_vec/test_fs.glsl", fragment_shader, 1024 * 256);
