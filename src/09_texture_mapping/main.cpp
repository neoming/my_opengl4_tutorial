...
int main() {
  ...
  GLuint shader_programme = create_programme_from_files( "src/09_texture_mapping/test_vs.glsl", "src/09_texture_mapping/test_fs.glsl" );
...
#define ONE_DEG_IN_RAD ( 2.0 * M_PI ) / 360.0 // 0.017444444
  ...
  // load texture
  GLuint tex;
  ( load_texture( "src/09_texture_mapping/skulluvmap.png", &tex ) );
