...
int main() {
  ...
  parse_file_into_str( "src/03_vertex_buffer_objects/test_vs.glsl", vertex_shader, 1024 * 256 );
  parse_file_into_str( "src/03_vertex_buffer_objects/test_fs.glsl", fragment_shader, 1024 * 256 );
