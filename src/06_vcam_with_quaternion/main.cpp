...
#include <math.h>
#define MESH_FILE "src/06_vcam_with_quaternion/sphere.obj"
#define VERTEX_SHADER_FILE "src/06_vcam_with_quaternion/test_vs.glsl"
#define FRAGMENT_SHADER_FILE "src/06_vcam_with_quaternion/test_fs.glsl"
