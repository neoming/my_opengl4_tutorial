...
int main() {
  ...
  ( parse_file_into_str( "src/22_geom_shaders/test_vs.glsl", vertex_shader, 1024 * 256 ) );
  ( parse_file_into_str( "src/22_geom_shaders/test_gs.glsl", geometry_shader, 1024 * 256 ) );
  ( parse_file_into_str( "src/22_geom_shaders/test_fs.glsl", fragment_shader, 1024 * 256 ) );
