...
#include <stdio.h>
#include <stdlib.h>
#define MESH_FILE "src/07_ray_picking/sphere.obj"
#define VERTEX_SHADER_FILE "src/07_ray_picking/test_vs.glsl"
#define FRAGMENT_SHADER_FILE "src/07_ray_picking/test_fs.glsl"
